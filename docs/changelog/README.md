...
- [color-picker] Remove color palettes and add confirmation buttons to the dialog. 

## [1.13.0] - 2025-11-04

- [system-bar-alert] Fixes the color of the dismissible icon.

## [1.12.2] - 2025-09-09

- [calendar-field] Fixes errors in the translation of input validations.
- [date-time-field] Fixes errors in the translation of input validations.
